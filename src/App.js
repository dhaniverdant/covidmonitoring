...
function App() {
  ...
  return (
    <div>
      ...
      <div className="footer">Copyright {'\u00A9'} {new Date().getFullYear()} <a className="footer-link" href="https://www.linkedin.com/in/rahmad-ramdhani-a08102131/">Rahmad Ramdhani</a></div>
    </div>
  );
}
